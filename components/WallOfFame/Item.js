            ...
            <center>
                <div style={{ width: '100%', maxWidth: '1200px' }}>
                    <div style={viewport.styler.initial({
                        ...
                        display: 'grid',
                        gridTemplateColumns: '1fr min(100%, 500px)',
                        boxSizing: 'border-box'
                    }).styles}>
                        <div style={viewport.styler.initial({
                        ...
                        <div style={{
                            ...
                            <center style={{ boxSizing: 'border-box', width: '100%' }}>
                                <img src={`/assets/wall-of-fame/${image}`} style={{ boxSizing: 'border-box', float: 'right', width: '100%', maxWidth: '600px', textAlign: 'center', border: '2px solid #1e2117', margin: '0px auto' }} />
                            </center>
                        </div>
                    </div>
                </div>
